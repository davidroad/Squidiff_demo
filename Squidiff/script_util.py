...
def model_and_diffusion_defaults():
    """
    Defaults for training (Official Squidiff defaults).
    """
    res = dict(
        output_dim=1000,
        num_layers=3,
        gene_size=1000,
        num_channels=128,
        dropout=0.0,  # Official default: no dropout
        class_cond=False,
...
def create_model_and_diffusion(
    ...
    drug_dimension,
    comb_num,
    hidden_sizes=2048,  # Official default
    latent_dim=60,  # Official default
):
    model = create_model(
        gene_size,
        num_layers,
