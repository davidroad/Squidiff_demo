...
class MLPModel(nn.Module):
    ...
    def __init__(self,
                 ...
                 output_dim,
                 num_layers,
                 hidden_sizes=2048,  # Official default: 2048
                 time_pos_dim=2048,  # Official default: 2048
                 num_classes = None,
                 latent_dim=60,  # Official default: 60
                 use_checkpoint=False,
                 use_fp16 = False,
                 use_scale_shift_norm =False,
                 dropout=0,
                 time_embed_dim=2048,  # Official default: 2048
                 use_encoder=False,
        ...
        if use_encoder:
            self.encoder = EncoderMLPModel(gene_size, self.hidden_sizes, self.num_classes, use_drug_structure, self.drug_dimension, comb_num, output_size=latent_dim)
...
class EncoderMLPModel(nn.Module):
    ...
    def __init__(self, input_size, hidden_sizes, num_classes=None, use_drug_structure=False, drug_dimension=1024,comb_num=1,output_size=60, dropout=0.0, use_fp16=False):  # Official defaults: output_size=60, dropout=0.0
...
class EncoderMLPModel2(nn.Module):
    def __init__(self, input_size, hidden_sizes, num_classes=None, output_size=60, dropout=0.0, use_fp16=False):  # Official default: dropout=0.0
